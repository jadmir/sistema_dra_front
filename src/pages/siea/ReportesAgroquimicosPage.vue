      ...
      <div class="row items-center q-mb-lg">
        <div class="col">
          <div class="text-h4 text-weight-bold text-primary">
            <q-icon name="pest_control" size="md" class="q-mr-sm" />
            Reportes de Agroquímicos (F-6)
          </div>
          <div class="text-subtitle2 text-grey-7">
            Consulta y exporta reportes de precios de agroquímicos
          </div>
        </div>
      </div>
            ...
            <template v-slot:body-cell-categoria="props">
              <q-td :props="props">
                <q-chip
                  ...
                  text-color="white"
                  size="sm"
                  :icon="getCategoriaIcon(props.row.producto_categoria)"
                >
...
const {
  ...
  exportarExcel,
  exportarPDF,
} = useReportesSIEA('agroquimicos')

// Categorías F-6: Agroquímicos
const tiposOptions = ['HERBICIDA', 'INSECTICIDA', 'FUNGICIDA', 'ACARICIDA', 'OTROS']
...
// Función para asignar icono a cada categoría
function getCategoriaIcon(categoria) {
  const iconos = {
    HERBICIDA: 'grass',
    INSECTICIDA: 'bug_report',
    FUNGICIDA: 'coronavirus',
    ACARICIDA: 'pest_control',
    OTROS: 'science',
  }
  return iconos[categoria] || 'science'
}
</script>
